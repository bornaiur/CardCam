...
//    public native void ConvertRGBtoGray(long matAddrInput, long matAddrResult);
    public native boolean FindEdgeAndDraw(long matAddrInput, long matAddrResult);
...
//    public long cascadeClassifier_eye = 0;
    ...
    private BaseLoaderCallback mLoaderCallback = new BaseLoaderCallback(this) {
        ...
        public void onManagerConnected(int status) {
            Log.d("onManagerConnecte", "public void onManagerConnecte");
            switch (status) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("oncreate", "public void oncreate");
...
//        mOpenCvCameraView.setCameraIndex(1); // front-camera(1),  back-camera(0)
    ...
    {
        super.onPause();
        Log.d("onpause", "public void onManagerConnecte");
    ...
    {
        super.onResume();
        Log.d("onresume", "public void onManagerConnecte");
    ...
    public void onDestroy() {
        Log.d("ondestroy", "public void onManagerConnecte");
        super.onDestroy();
    ...
    public void onCameraViewStarted(int width, int height) {
        Log.d("cvstart", "public void onManagerConnecte");
    }

    @Override
    public void onCameraViewStopped() {
        Log.d("cvstop", "public void onManagerConnecte");
    }
...
//        ConvertRGBtoGray(matInput.getNativeObjAddr(), matResult.getNativeObjAddr());
        if(FindEdgeAndDraw(matInput.getNativeObjAddr(), matResult.getNativeObjAddr())){
